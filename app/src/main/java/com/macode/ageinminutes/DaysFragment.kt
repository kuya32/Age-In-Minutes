...
class DaysFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val toolbar = view.findViewById<androidx.appcompat.widget.Toolbar>(R.id.daysToolbar)
        val selectDateButton = view.findViewById<Button>(R.id.daysSelectDateButton)

        (requireActivity() as AppCompatActivity).setSupportActionBar(toolbar)
        (requireActivity() as AppCompatActivity).supportActionBar?.title = "Age in Days"
    ...
    private fun clickDatePicker(view: View?) {
        ...
        val dateSetListener = DatePickerDialog(requireActivity(), R.style.DialogDate, { view, selectedYear, selectedMonth, selectedDayOfMonth ->
            ...
            daysSelectedDate.text = selectedDate
            ...
            daysInDaysTillDate.text = differenceInDays.toString()
        }, year, month, day)
